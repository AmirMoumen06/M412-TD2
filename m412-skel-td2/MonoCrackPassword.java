...
public class MonoCrackPassword {
	...
	private MonoCrackPassword(String passUncrypted)
	...
	private MonoCrackPassword(String passEncrypted, int uncryptedLength) {
	...
	public static void main(String[] args) throws
		...
		MonoCrackPassword mcpE = new MonoCrackPassword(
